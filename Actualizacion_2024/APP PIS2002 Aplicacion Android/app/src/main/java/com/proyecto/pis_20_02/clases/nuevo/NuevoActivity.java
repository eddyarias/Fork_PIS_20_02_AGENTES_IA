...
package com.proyecto.pis_20_02.clases.nuevo;
...
import com.proyecto.pis_20_02.clases.codigo.CodigoActivity;
import com.proyecto.pis_20_02.clases.login.LoginActivity;
                                        ...
                                        Amplify.Auth.signUp(username, contrasena, options, result -> NuevoActivity.this.runOnUiThread(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                if (String.valueOf(error.getCause()).equals(mensaje)) {
                                                    Toast.makeText(getApplicationContext(), "Error al crear el usuario. El Nombre de Usuario ya exite", Toast.LENGTH_SHORT).show();
                                                } else {
