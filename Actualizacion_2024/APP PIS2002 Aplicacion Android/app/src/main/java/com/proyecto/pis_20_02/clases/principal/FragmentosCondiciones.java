...
import com.proyecto.pis_20_02.databinding.FragmentoPrincipalCondicionesBinding;
...
public class FragmentosCondiciones extends Fragment {
    ...
    private FragmentoPrincipalCondicionesBinding vinculador;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        vinculador = FragmentoPrincipalCondicionesBinding.inflate(inflater, container, false);
    ...
    private void presentarAlertas() {
        try {
            ...
            final ImageView resultadoBandera = vinculador.imagenBanderaCondiciones;
            final TextView resultadoTexto = vinculador.txtMedidaCondiciones;
            final TextView porcentaje = vinculador.txtPorcentajeCondiciones;
