...
package com.proyecto.pis_20_02.clases.recuperar;
                        ...
                        Amplify.Auth.resetPassword(usuarioRecuperacion.getText().toString(), result -> RecuperarActivity.this.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (String.valueOf(error.getCause()).equals(mensaje)) {
                                    ...
                                    Toast.makeText(getApplicationContext(), "El Nombre de Usuario no exite. Ingrese un usuario valido", Toast.LENGTH_SHORT).show();
                                } else {
