...
import com.proyecto.pis_20_02.databinding.FragmentoPrincipalFlujoBinding;
...
public class FragmentosFlujo extends Fragment {
    ...
    private FragmentoPrincipalFlujoBinding vinculador;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        vinculador = FragmentoPrincipalFlujoBinding.inflate(inflater, container, false);
    ...
    private void presentarAlertas() {
        try {
            ...
            final ImageView resultadoBandera = vinculador.imagenBanderaFlujos;
            final TextView resultadoTexto = vinculador.txtMedidaFlujos;
            final TextView porcentaje = vinculador.txtPorcentajeFlujos;
